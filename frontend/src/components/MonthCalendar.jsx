        ...
        <div className="mx-auto bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
            ...
            <div className="flex justify-between items-center mb-6">
                <button 
                    ...
                    className="px-3 py-1.5 text-sm font-medium bg-gray-50 hover:bg-gray-100 rounded-lg transition-colors text-gray-600"
                >
                    &lt; 이전
                </button>
            ...
            <div className="grid grid-cols-7 gap-2">
                ...
                {daysArray.map((day) => {
                    ...
                    return (
                        <div 
                            key={day} 
                            className={`h-21 border rounded-xl flex flex-col justify-between p-2 transition-all cursor-pointer hover:shadow-sm ${colorClass}`}
                        >
